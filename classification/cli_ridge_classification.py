...
from tabular_prediction.methods import ridge_predict
...
def run_evaluation(split):
    ...
    with open(f"../results/ridge-classification-{split}.csv", "a") as f:
        ...
        for i, dataset in enumerate(datasets):
            ...
            test_y, summary, _ = ridge_predict(x_train, y_train, x_test, y_test, cat_features=cat_features, metric_used=cross_entropy_metric, max_time=max_time)

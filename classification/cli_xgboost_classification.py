...
from tabular_prediction.methods import xgboost_predict
...
def run_evaluation(split, gpu_id=0):
    ...
    result_file = f"../results/xgboost-classification-{split}.csv"
    ...
    with open(result_file, "a") as f:
        for i, dataset in enumerate(datasets):
            ...
            test_y, summary, _ = xgboost_predict(x_train, y_train, x_test, y_test, cat_features=cat_features, metric_used=cross_entropy_metric, max_time=max_time, gpu_id=gpu_id)

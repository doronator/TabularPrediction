...
from tabular_prediction.methods import randomforest_predict
...
def run_evaluation(split):
    ...
    result_file = f"../results/randomforest-classification-{split}.csv"
    ...
    with open(result_file, "a") as f:
        for i, dataset in enumerate(datasets):
            ...
            test_y, summary, _ = randomforest_predict(x_train, y_train, x_test, y_test, cat_features=cat_features, metric_used=cross_entropy_metric, max_time=max_time)
